...
CREATE TABLE `assinaturas` (
  `assinante` varchar(30) COLLATE utf8_bin NOT NULL,
  `assinado` varchar(30) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`assinante`,`assinado`),
  KEY `assinaturas_email_assinante` (`assinado`),
  CONSTRAINT `assinaturas_email_assinado` FOREIGN KEY (`assinante`) REFERENCES `usuarios` (`email`),
  CONSTRAINT `assinaturas_email_assinante` FOREIGN KEY (`assinado`) REFERENCES `usuarios` (`email`)
